...
export type FetchOrdersQuery = { __typename?: 'Query', fetchOrders: Array<{ __typename?: 'Order', id: number, totalPrice: number, foods: any, status: OrderStatus, deliveryPerson?: string | null, deliveryTime?: any | null, customerId: string, restaurantId: string, deliveryAddress: string, createdAt: any }> };
